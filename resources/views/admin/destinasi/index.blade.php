      ...
      <div class="card">
        ...
        <div class="form-group col-md-12 text-center">
            ...
            <div class="form-group col-md-12">
                <a href="{{url('destinasi/create')}}" class="btn btn-primary btn-sm">
            ...
            <tbody class="text-center">
                @foreach($destinasi as $key=>$data)
                  <tr>
                    ...
                    <td>
                      <a href="{{url('destinasi/edit').'/'.$data->id}}" class="btn btn-sm btn-warning">Edit <i class="fas fa-pencil-alt"></i></a>
                      <button onclick="deleteDestinasi({{$data->id}})" class="btn btn-sm btn-danger">Delete <i class="fas fa-trash"></i></button>
                    </td>
                  </tr>
                @endforeach
            </tbody>
  ...
  function deleteDestinasi(id){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location = 'destinasi/delete/'+id;
      }
    });
  }
