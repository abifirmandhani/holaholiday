        ...
        <div class="form-group col-md-12 text-center">
            ...
            <section class="section section-lg section-top-1" style="margin-top:100px">
                ...
                <div class="box-categories cta-box-wrap">
                    ...
                    <div>
                        <form action="{{url('landing/pemesanan'.'/'.$paket->id)}}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="Rp {{$paket->harga}}" class="form-control" required readonly>
                            </div>
                            <input type="hidden" value="paket" name="type">
